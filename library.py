...
# books_with_details is a list with nested dictionaries. This data structure is indicated by the outer square brackets defininig a list, and the inner curly braces containing key-value pairs, which is the structure of a dictionary.
...
titles = search_by_author('Yuval Noah Harari')
print(titles)
